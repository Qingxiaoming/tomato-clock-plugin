...
const dict: Record<string, Record<Lang, string>> = {
    ...
    'settings.statusBarModeDesc': { en: 'Choose how the timer appears in the status bar: full (time + status), simple (running/paused only), or hidden.', zh: '选择计时器在状态栏的显示方式：完整模式（显示时间和状态）、简洁模式（只显示是否计时中）或隐藏。' },
